...
#include "pool.hpp"
void textRender::setup_font(std::map<std::string,GLuint>& shaders)
{
    ...
    char font_name[] = "scenes/animation/Pool_game/assets/bitter_font/BitterPro-Black.ttf";
    FT_Face face;
    ...
    for (unsigned char c = 0; c < 128; ++c) {
        ...
        Character character = {
                texture,
                vcl::vec2(face->glyph->bitmap.width, face->glyph->bitmap.rows),
                vcl::vec2(face->glyph->bitmap_left, face->glyph->bitmap_top),
...
// render line of text
// -------------------
void textRender::renderText(std::string text, float x, float y, float scale, vcl::vec3 color)
{
